...
export default function RestaurantPreviewBottomSheet({
    restaurant,
    onClose,
    }: Props) {
    ...
    return (
        ...
        className="absolute bottom-[84px] left-4 right-4 z-30 rounded-[28px] bg-white px-4 pb-5 pt-3 shadow-[0_8px_30px_rgba(0,0,0,0.15)]"
        >
