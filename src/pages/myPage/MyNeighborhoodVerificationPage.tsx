...
//     useEffect(() => {
//         if (!location || hasShownModal) return;
...
//             navigate("/mypage");
//         } catch (error) {
//             toast.error(error instanceof Error ? error.message : "동네 인증 실패");
//         } finally {
//             setSubmitting(false);
//         }
//     };
...
//                     </div>
//                 )}
//                 {/* 지도 위 로딩 오버레이 (위치는 있지만 갱신 중일 때도 표시 가능) */}
...
//                             <button
//                                 className="flex-1 cursor-pointer rounded-xl bg-gray-200 py-2 text-sm transition-colors hover:bg-gray-300"
...
//                             <button
//                                 className="flex-1 cursor-pointer rounded-xl bg-orange-500 py-2 text-sm font-bold text-white transition-colors hover:bg-orange-600"
...
//             {/* 모달이 닫혀있고, 이미 한 번 띄운 적 있을 때 = 취소한 상태 */}
//             {!showConfirmModal && hasShownModal && regionName && (
//                 <button
//                     type="button"
...
const MyNeighborhoodVerificationPage = () => {
    ...
    const redirectPath = `/mypage/neighborhood-verification`;
...
// //v1 - 동네 이름 확인 없이 바로 인증 - previewAPI 만들기 여부.
// import { useEffect, useState } from "react";
// import { useNavigate } from "react-router-dom";
// import { toast } from "sonner";
